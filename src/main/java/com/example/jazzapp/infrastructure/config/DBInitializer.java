package com.example.jazzapp.infrastructure.config;
...
import com.example.jazzapp.domain.enums.DanceEnum;
import com.example.jazzapp.domain.repository.LessonRepository;
import com.example.jazzapp.domain.repository.StepRepository;
